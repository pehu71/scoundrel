...
var loadConfig = function () {
    ...
    if (process.argv[2] === undefined) {
        console.error("The configuration file path is incorrect. Exiting Scoundrel.\r\n");
        return false;
    }
...
// todo: print help when no file sopecified (e.g. nothing for argv[2])
// todo: print help when params: --help, --h
// todo: print version when params: --version, --v
