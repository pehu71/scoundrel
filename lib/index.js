...
var loadConfig = function () {
    ...
    if (configPath !== undefined) {
        try {
            ...
            console.error("The configuration file path is incorrect or configuration file is an empty file.\r\n");
            return false;
        }
        config = require(configPath).getConfig();
    } else {
        console.error('The configuration file was not specified.');
        return false;
    }
    return true;
};
